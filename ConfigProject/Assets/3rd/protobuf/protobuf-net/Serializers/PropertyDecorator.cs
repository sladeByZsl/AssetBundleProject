...
namespace ProtoBuf.Serializers
{
    sealed class PropertyDecorator : ProtoDecoratorBase
    {
        ...
        public override void Write(object value, ProtoWriter dest)
        {
			...
			else if(property.GetGetMethod(true) != null)
			{
        ...
        public override object Read(object value, ProtoReader source)
        {
			...
			if(property.GetGetMethod() != null)
			{
				m_value = property.GetGetMethod().Invoke(value, null);
			}
			else if(property.GetGetMethod(true) != null)
			{
				m_value = property.GetGetMethod(true).Invoke(value, null);
			}
			else
			{
				m_value = null;
			}
			object oldVal = Tail.RequiresOldValue ? m_value : null;
